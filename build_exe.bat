...
set "APP_NAME=ZE-SG3 Torque Acquisition v2.0.4"
...
set "ISS=iss\ZE-SG3 Torque Acquisition2.0.4.iss"
...
echo Output SETUP: iss\mysetupZE-SG3 Torque Acquisition v2.0.4.exe
goto :end
