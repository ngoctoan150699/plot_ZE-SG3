...
set "APP_NAME=ZE-SG3 Torque Acquisition v2.0.7"
...
set "ISS=iss\ZE-SG3 Torque Acquisition2.0.7.iss"
...
echo Output SETUP: iss\mysetupZE-SG3 Torque Acquisition v2.0.7.exe
goto :end
