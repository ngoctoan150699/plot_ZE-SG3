...
set "APP_NAME=ZE-SG3 Torque Acquisition v2.0.10"
...
set "ISS=iss\ZE-SG3 Torque Acquisition2.0.10.iss"
...
echo Output SETUP: iss\mysetupZE-SG3 Torque Acquisition v2.0.10.exe
goto :end
