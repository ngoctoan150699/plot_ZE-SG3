...
TRANSLATIONS = {
    'vi': {
        ...
        'test_item_angle': 'Đo góc',
        'angle_positive_torque_lbl': 'Giới hạn mô-men dương:',
        'angle_negative_torque_lbl': 'Giới hạn mô-men âm:',
        'angle_zero_question': 'Bạn hoàn thành set góc 0 chưa?',
        'angle_measure_question': 'Bạn hoàn thành việc đo góc chưa?',
        'angle_done_btn': 'Xong',
        'angle_complete_btn': 'Hoàn thành',
        'angle_running_positive': 'Đang quay chiều dương đến giới hạn mô-men...',
        'angle_running_negative': 'Đang quay chiều âm đến giới hạn mô-men...',
        'angle_returning_origin': 'Đang trở về vị trí 0 ban đầu...',
        'angle_completed': 'Chương trình đo góc đã hoàn thành.',
        'angle_invalid_limits': 'Giới hạn dương phải > 0 và giới hạn âm phải < 0.',
        'angle_plc_required': 'Chương trình đo góc yêu cầu kết nối PLC.',
        'angle_dialog_title': 'Chương trình đo góc',
    ...
    'en': {
        ...
        'test_item_angle': 'Angle Measurement',
        'angle_positive_torque_lbl': 'Positive torque limit:',
        'angle_negative_torque_lbl': 'Negative torque limit:',
        'angle_zero_question': 'Have you finished setting zero angle?',
        'angle_measure_question': 'Have you finished measuring the angle?',
        'angle_done_btn': 'Done',
        'angle_complete_btn': 'Complete',
        'angle_running_positive': 'Rotating positive to the torque limit...',
        'angle_running_negative': 'Rotating negative to the torque limit...',
        'angle_returning_origin': 'Returning to the initial zero position...',
        'angle_completed': 'Angle measurement program completed.',
        'angle_invalid_limits': 'Positive limit must be > 0 and negative limit must be < 0.',
        'angle_plc_required': 'Angle measurement requires a PLC connection.',
        'angle_dialog_title': 'Angle Measurement',
